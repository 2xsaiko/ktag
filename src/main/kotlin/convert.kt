...
internal fun <T : TagBase?> T.asByte() = when (this) {
  is TagByte   -> value
...
internal fun <T : TagBase?> T.asShort() = when (this) {
...
internal fun <T : TagBase?> T.asInt() = when (this) {
...
internal fun <T : TagBase?> T.asLong() = when (this) {
...
internal fun <T : TagBase?> T.asFloat() = when (this) {
...
internal fun <T : TagBase?> T.asDouble() = when (this) {
...
internal fun <T : TagBase?> T.asByteArray() = when (this) {
...
internal fun <T : TagBase?> T.asString() = when (this) {
  is TagString -> value
  else         -> null
}

internal fun <T : TagBase?> T.asTagList() = when (this) {
  is TagList -> value
  else       -> null
}

internal fun <T : TagBase?> T.asTagCompound() = when (this) {
  is TagCompound -> value
  else           -> null
}

internal fun <T : TagBase?> T.asIntArray() = when (this) {
...
internal fun <T : TagBase?> T.asLongArray() = when (this) {
